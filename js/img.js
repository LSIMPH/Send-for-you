$(function () {
    ...
    function feiru() {
        if ((leng - 1) > i) {
            ...
            $('.begin').html('<a href="https://www.facebook.com/lose.rzero.re/?locale=vi_VN" style="text-decoration: none;color: #fff;background: pink;display: inline-block;padding: 10px;border: 2px solid #fff;">Có lời gì muốn nói thì bấm :V</a>');
            $('.begin').fadeIn();
            return;
        }
    };
